...
interface ModalProps extends Omit<HTMLAttributes<HTMLDivElement>, "content" | "title"> {
	title?: string;
		...
		>
			...
			>
				<div className="flex p-5 pr-6">
					...
					<div>
						<h1 className="text-lg mb-1 tracking-wide text-neutral-800 font-semibold">{title}</h1>
