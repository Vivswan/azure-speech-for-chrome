	...
	return (
		<div className="flex flex-col w-56 p-2 py-2.5 border-r">
			<div className="flex items-center mb-3 mx-1 ml-3">
				<img src="images/icon_1000.png" className="mr-1.5 pt-0.5" style={{ width: "26px" }} />
				<div>
					<div className="whitespace-nowrap text-sm font-bold text-neutral-800">{t("app.name")}</div>
					<div className="text-xs font-bold text-neutral-500" style={{ fontSize: "10px", marginTop: "-5px" }}>
						{t("app.subtitle")}
					</div>
				</div>
			</div>
			...
			<div className="mt-auto">
				...
				<Sidebar.Item Icon={GitHub} color="bg-neutral-600" to="https://github.com/vivswan/azure-speech-for-chrome">
