									...
									content={
										<div>
											...
											<ol className="list-decimal list-inside mt-2 space-y-1">
												<li>
													{t("help.azure_setup.create_account.step1")}{" "}
													<a
									...
									content={
										<div>
											...
											<div className="bg-red-50 border-l-4 border-red-400 p-4 mt-4">
												<p className="text-red-800 font-semibold">{t("help.azure_setup.get_keys.security_warning")}</p>
												<p className="text-red-700 mt-1">{t("help.azure_setup.get_keys.security_text")}</p>
											</div>
										</div>
									}
								/>
											...
											<div className="grid grid-cols-2 gap-4 mt-4">
												<div>
													...
													<ul className="list-disc list-inside mt-2 space-y-1 text-sm">
														<li>
															<code>eastus</code> - {t("help.azure_setup.choose_region.us_east")}
														</li>
														<li>
															<code>westus2</code> - {t("help.azure_setup.choose_region.us_west")}
														</li>
														<li>
															<code>westeurope</code> - {t("help.azure_setup.choose_region.eu_west")}
														</li>
														<li>
															<code>southeastasia</code> - {t("help.azure_setup.choose_region.ap_southeast")}
														</li>
													</ul>
												</div>
												<div>
													...
													<p className="text-sm mt-2">
														<a
															href="https://learn.microsoft.com/en-us/azure/cognitive-services/speech-service/regions"
															target="_blank"
															className="text-blue-600 hover:underline"
														>
															{t("help.azure_setup.choose_region.see_docs")}
														</a>
													</p>
												</div>
											</div>
							...
							<div className="space-y-4">
								...
								<div>
									...
									<p className="text-sm text-gray-600 mt-2">
										<a
											href="https://learn.microsoft.com/en-us/azure/cognitive-services/speech-service/speech-synthesis-markup"
											target="_blank"
											className="text-blue-600 hover:underline"
										>
								...
								<div className="grid md:grid-cols-2 gap-6">
									<div>
										...
										<ul className="space-y-2">
											<li>
												<a
													href="https://github.com/vivswan/azure-speech-for-chrome/issues"
													target="_blank"
													className="text-blue-600 hover:underline"
												>
											...
											<li>
												<a
													href="https://github.com/vivswan/azure-speech-for-chrome"
													target="_blank"
													className="text-blue-600 hover:underline"
												>
											...
											<li>
												<a
													href="https://vivswan.github.io/azure-speech-for-chrome/privacy-policy.html"
													target="_blank"
													className="text-blue-600 hover:underline"
												>
									...
									<div>
										...
										<ul className="space-y-2">
											<li>
												<a
													href="https://learn.microsoft.com/en-us/azure/cognitive-services/speech-service/"
													target="_blank"
													className="text-blue-600 hover:underline"
												>
