...
const translations: Translations = {
	en: {
		...
		description:
			"Convert any text on the web into high-quality, natural-sounding audio with Azure Speech Services' advanced AI voices. 140+ languages, 400+ voices.",
		nav: {
			features: "Features",
		...
		hero: {
			...
			description:
				"Convert any text on the web into high-quality, natural-sounding audio with Azure Speech Services' advanced AI voices. Choose from 140+ languages and 400+ professional voices.",
			cta: {
	...
	"zh-CN": {
		...
		description:
			"使用 Azure 语音服务的先进 AI 语音技术，将网页上的任何文字转换为高质量、自然的音频。支持 140 多种语言和 400 多种语音。",
		nav: {
			features: "功能特色",
			screenshots: "屏幕截图",
			install: "安装",
		...
		hero: {
			title: "将文字转换为自然语音",
			description:
				"使用 Azure 语音服务的先进 AI 语音技术，将网页上的任何文字转换为高质量、自然的音频。可从 140 多种语言和 400 多种专业语音中选择。",
			cta: {
	...
	"zh-TW": {
		...
		description:
			"使用 Azure 語音服務的先進 AI 語音技術，將網頁上的任何文字轉換為高品質、自然的音訊。支援 140 多種語言和 400 多種語音。",
		nav: {
			features: "功能特色",
			screenshots: "螢幕截圖",
			install: "安裝",
		...
		hero: {
			title: "將文字轉換為自然語音",
			description:
				"使用 Azure 語音服務的先進 AI 語音技術，將網頁上的任何文字轉換為高品質、自然的音訊。可從 140 多種語言和 400 多種專業語音中選擇。",
			cta: {
	...
	hi: {
		...
		description:
			"Azure Speech Services के उन्नत AI आवाज़ों के साथ वेब पर किसी भी टेक्स्ट को उच्च-गुणवत्ता, प्राकृतिक ऑडियो में बदलें। 140+ भाषाएं, 400+ आवाज़ें।",
		nav: {
			features: "विशेषताएं",
		...
		hero: {
			...
			description:
				"Azure Speech Services के उन्नत AI आवाज़ों के साथ वेब पर किसी भी टेक्स्ट को उच्च-गुणवत्ता, प्राकृतिक ऑडियो में बदलें। 140+ भाषाओं और 400+ पेशेवर आवाज़ों में से चुनें।",
			cta: {
