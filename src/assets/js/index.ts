  ...
  en: {
    ...
    features: {
      ...
      processing: {
        ...
        description: 'Automatically sanitizes HTML content and handles special characters safely using advanced algorithms'
      },
      shortcuts: {
      ...
      ssml: {
        title: 'SSML Support',
        description: 'Advanced markup language for precise speech control including pauses, emphasis, and pronunciation'
      }
    },
    howto: {
      title: 'How It Works',
  ...
  hi: {
    ...
    features: {
      ...
      processing: {
        ...
        description: 'HTML कंटेंट को अपने आप साफ करता है और उन्नत एल्गोरिदम का उपयोग करके विशेष वर्णों को सुरक्षित रूप से हैंडल करता है'
      },
      shortcuts: {
...
function updateContent(lang: string): void {
  ...
  if (htmlElement) htmlElement.lang = lang === 'zh-CN' ? 'zh-CN' : lang === 'zh-TW' ? 'zh-TW' : lang === 'hi' ? 'hi' : 'en'
