// Messaging utilities for communicating with tabs and content scripts

export function retrieveSelection(): string {
...
export async function sendMessageToCurrentTab(event: any): Promise<void> {
